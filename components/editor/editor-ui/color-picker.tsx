...
function ColorPickerTrigger(props: ColorPickerTriggerProps) {
  ...
  return (
    <PopoverTrigger data-slot="color-picker-trigger" disabled={context.disabled} {...props} />
  );
}
...
function ColorPickerContent(props: ColorPickerContentProps) {
  ...
  if (context.inline) {
    const inlineProps = popoverContentProps as React.HTMLAttributes<HTMLDivElement>;
